# Autogenerated wrapper script for OpenFHE_jll for x86_64-apple-darwin
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libOPENFHEbinfhe,
        "lib/libOPENFHEbinfhe.1.1.4.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libOPENFHEcore,
        "lib/libOPENFHEcore.1.1.4.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libOPENFHEpke,
        "lib/libOPENFHEpke.1.1.4.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
